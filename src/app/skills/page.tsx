...
export default function SkillsPage() {
  const skills = [
    ...
    },
    {
      ...
      text: "my problem solving is pretty solid too (helped rakha and sulthan fix their broken arch linux setups looking for more arch victims rn and i fixed some other student broken code)",
    },
  ];
